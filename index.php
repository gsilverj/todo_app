...
include_once 'app/code/core/core/Functions.php';
include_once getcwd() . DS . 'app' . DS . 'code' . DS .  'core' . DS . 'core' . DS . 'Bootstrap.php';
...
include_once getcwd() . DS . 'app' . DS . 'code' . DS .  'core' . DS . 'core' . DS . 'models' . DS .  'DbServicesModel.php';

include_once getcwd() . DS . 'app' . DS . 'code' . DS .  'core' . DS . 'core' . DS . 'Install.php';
